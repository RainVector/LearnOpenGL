...
// graphics loop function.  主要就是render相关，与仿真无关
void displayFunction(void)
{
...
// called periodically by GLUT:   周期性更新力。。。。。？？？？
void idleFunction(void)
{
  ...
  // reset external forces (usually to zero) des:f_ext, src: f_extBase, 长度
...
// reacts to pressed "special" keys 控制镜头的移动
...
// reacts to mouse motion 控制镜头的移动
...
// reacts to pressed mouse buttons  鼠标对物体施加里的更新？？？？？
